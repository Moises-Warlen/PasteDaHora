...
namespace Pastelaria.Repository
{
    ...
    public class UsuarioRepository : BaseRepository, IUsuarioRepository
    {
        ...
        private enum Procedures
        {
            ...
            DesativarUsuario,  // Desativar usuário e seus associados
            BuscarUsuarios,     // Listar usuários ativos
        ...
        {
            ExecuteProcedure(Procedures.BuscarUsuarios);  // Executa o procedimento armazenado para buscar usuários ativos
        ...
        {
            ExecuteProcedure(Procedures.DesativarUsuario);  // Executa o procedimento armazenado para desativar o usuário
